...
namespace Geometry.Planimetry
{
    public struct Ray2F
    {
        ...
        public Ray2F(Vector2F startPoint, Vector2F direction)
        {
        ...
        public Ray2 ToDouble()
        {
            return new Ray2(this.BasicPoint.ToDouble(), this.direction.ToDouble());
        }
    }
}
