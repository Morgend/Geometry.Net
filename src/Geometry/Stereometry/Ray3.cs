...
namespace Geometry.Stereometry
{
    public struct Ray3
    {
        ...
        public Ray3(Vector3 startPoint, Vector3 direction)
        {
        ...
        public Ray3F ToFloat()
        {
            return new Ray3F(this.BasicPoint.ToFloat(), this.direction.ToFloat());
        }
    }
}
