...
namespace Geometry.Stereometry
{
    public struct Ray3F
    {
        ...
        public Ray3F(Vector3F startPoint, Vector3F direction)
        {
        ...
        public Ray3 ToDouble()
        {
            return new Ray3(this.BasicPoint.ToDouble(), this.direction.ToDouble());
        }
    }
}
